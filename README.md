...
アーキテクチャ図は [outputs/pre-push-security-gate-architecture.drawio](outputs/pre-push-security-gate-architecture.drawio) にあります。VS Code の Draw.io 拡張でそのまま開いて編集できます。
